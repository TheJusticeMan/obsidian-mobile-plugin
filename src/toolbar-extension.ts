    ...
    class {
      ...
      isCommandAvailable(commandId: string, view: EditorView): boolean {
        ...
        if (command.checkCallback) {
          try {
            // eslint-disable-next-line @typescript-eslint/no-unsafe-return, @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-member-access -- Obsidian's commands API is not typed
